(function () {
  ...
  function renderAccounts() {
    ...
    return `<div class="sales-view sales-accounts-view">${renderAccountsFilter()}
      ...
      <div class="operations-pagination"><span>共 ${groups.length} 条数据</span><select aria-label="每页条数"><option>20 条/页</option></select><button type="button" class="btn btn-sm" disabled>‹</button><button type="button" class="btn btn-primary btn-sm">1</button><button type="button" class="btn btn-sm" disabled>›</button><span>跳至</span><input value="1" aria-label="跳转页码"><span>/ 1 页</span></div>
    </div>`;
  }

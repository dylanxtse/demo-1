(function () {
  function autoSelectByHref(menu, currentPath, pageKey = '') {
    const routeAliases = {
      ...
      'supplier-bid-detail.html': 'supplier.html',
      'supplier-bidding-quotation-form.html': 'supplier.html',
      'supplier-bid-detail': 'supplier.html',
      'supplier-bidding-quotation-form': 'supplier.html',
